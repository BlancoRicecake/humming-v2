...
abstract class L10n {
  ...
  /// No description provided for @ltExportScopeLabel.
  ///
  /// In ko, this message translates to:
  /// **'내보낼 범위'**
  String get ltExportScopeLabel;

  /// No description provided for @ltExportScopeAll.
  ///
  /// In ko, this message translates to:
  /// **'전체 곡'**
  String get ltExportScopeAll;
  ...
  /// No description provided for @ltSongSaveFailed.
  ///
  /// In ko, this message translates to:
  /// **'변경 사항을 저장하지 못했어요. 기기의 저장 공간을 확인하고 다시 시도해 주세요.'**
  String get ltSongSaveFailed;

  /// No description provided for @policyNoticeTitle.
  ///
  /// In ko, this message translates to:
  /// **'약관 개정 안내'**
  String get policyNoticeTitle;

  /// No description provided for @policyNoticeEffective.
  ///
  /// In ko, this message translates to:
  /// **'시행일: {date}'**
  String policyNoticeEffective(String date);

  /// No description provided for @policyNoticeRead.
  ///
  /// In ko, this message translates to:
  /// **'내용 보기'**
  String get policyNoticeRead;

  /// No description provided for @policyNoticeAcknowledge.
  ///
  /// In ko, this message translates to:
  /// **'확인했어요'**
  String get policyNoticeAcknowledge;

  /// No description provided for @policyNoticeBody.
  ///
  /// In ko, this message translates to:
