...
void Win32Window::UpdateTheme(HWND const window) {
  // HumTrack uses a dark canvas regardless of the OS app theme.
  BOOL dark = TRUE;
  DwmSetWindowAttribute(window, DWMWA_USE_IMMERSIVE_DARK_MODE, &dark, sizeof(dark));
  const COLORREF caption = RGB(14, 14, 14);
  const COLORREF text = RGB(250, 250, 250);
  // Windows 11 caption/text colors; older Windows safely ignores these.
