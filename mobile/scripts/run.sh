...
CLARITY_PROJECT_ID_VAL="$(read_env CLARITY_PROJECT_ID)"
SENTRY_DSN_MOBILE_VAL="$(read_env SENTRY_DSN_MOBILE)"
...
[[ -n "$CLARITY_PROJECT_ID_VAL" ]] && DEFINES+=("--dart-define=CLARITY_PROJECT_ID=$CLARITY_PROJECT_ID_VAL")
[[ -n "$SENTRY_DSN_MOBILE_VAL" ]] && DEFINES+=("--dart-define=SENTRY_DSN_MOBILE=$SENTRY_DSN_MOBILE_VAL")
