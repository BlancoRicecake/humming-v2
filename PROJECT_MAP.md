...
> 본격 수정(대대적 리비전) 전 구조를 고정한다. 구조 기준일: 2026-06-07.
>
> **2026-09-04 추가** — 재개 감사 및 수정 내역: [docs/audit-2026-09-03.md](docs/audit-2026-09-03.md). 배포 순서는 [docs/DEPLOY-RUNBOOK-2026-09.md](docs/DEPLOY-RUNBOOK-2026-09.md), Mac 빌드는 [docs/MAC-WORKORDER-2026-09.md](docs/MAC-WORKORDER-2026-09.md).
