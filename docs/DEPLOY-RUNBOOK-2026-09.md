...
- [ ] 앱 내 공지 — 개정 문서가 번들된 새 빌드(1.0.6)가 곧 공지. **2026-09-20까지 스토어 출시**되어야 시행일 30일 전 조건 충족
- [ ] 출시가 09-20 을 넘기면 시행일을 출시일 +30일로 옮기고 12개 파일 재수정 (`docs/legal/notice-2026-09-05.md` 상단 목록)
