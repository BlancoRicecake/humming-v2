...
> 2026-09-03 갱신: 2·3(WAV/Stems)은 온디바이스 렌더로 출시됨. 1(Cloud backup)만 미구현 — paywall/계정 문구에서 클라우드 관련 약속은 제거함 ([audit-2026-09-03.md](audit-2026-09-03.md) M10). 전체 재개 감사 결과는 같은 문서 참고.
